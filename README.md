...
| `use_ratio_splits` | `train`, `val` | Sets fraction-based train/val/test splits; the data module normalizes them into fraction ranges and the dataset resolves them against time lazily (test = 1 − train − val) |
